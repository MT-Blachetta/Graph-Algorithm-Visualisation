...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        #self.buttonback.setAlignment(Qt.AlignCenter)
        self.buttonforward.setFont(QtGui.QFont('SansSerif', 16, QFont.Bold)) 
        #self.buttonforward.setAlignment(Qt.AlignCenter)
        self.loadbutton.setFont(QtGui.QFont('SansSerif', 16, QFont.Bold)) 
        #self.loadbutton.setAlignment(Qt.AlignCenter)
        ...
        #self.iterationlabel.setScaledContents(True)
    ...
    def lastIteration(self):
        print('start LISTINDEX back: '+ str(self.listindex))
        if self.listindex:
            self.listindex -= 1
            ...
            if not self.listindex:
                self.buttonback.setEnabled(False)
        print('end LISTINDEX back: '+ str(self.listindex))
    ...
    def nextIteration(self):
        print('start LISTINDEX next: '+ str(self.listindex))
        if self.listindex + 1 < len(self.stateTrack):
            ...
            print('VORHER -')
            print(self.algorithmState)
            print(self.phase_state)
        ...
        print('end LISTINDEX next: '+ str(self.listindex))

    def load_graph_from_text(self):
        inputtext = self.inputfield.text()
        #self.mainlabel.setText(inputtext)
        ...
        for n in nodes:
            ...
            if len(nlist) != 2: 
                ...
                return False
            #if not nlist[0].isalnum:
            #   self.mainlabel('Der Name eines Knotens darf nur aus Buchstaben und Zahlen bestehen')
            #   return False
